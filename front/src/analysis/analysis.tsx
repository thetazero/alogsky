...
import { average_pace, fastest_pace, fatigue, num_strides, total_mileage, total_tonage, training_time as total_training_time, training_heart_beats } from "./metrics";
